...
if (!$conn) {
  echo "Error Connecting To Database";
    ...
    if(isset($_POST['name']) && isset($_POST['slug'])){
        ...
        $query = "INSERT INTO location(name,slug)VALUES('$name','$slug')";
        if(mysqli_query($conn,$query)){
            echo '<div class="alert-banner">
                    ...
                    <span class="items-center">Location Created</span>
                    </label>
                </div>';
            exit();
        }
...
echo '<div class="alert-banner">
                    ...
                    <span class="items-center">Error During Location Creation</span>
                    </label>
                </div>';