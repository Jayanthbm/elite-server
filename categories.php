...
<body class="body-bg font-sans leading-normal tracking-normal">
		...
		<div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
			...
			<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20" id="nav-content">
				<ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="./videos.php" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                            <i class="fa fa-video fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Videos</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-green-400 hover:border-green-400">
                            <i class="fas fa-folder fa-fw mr-3 text-green-400"></i><span class="pb-1 md:pb-0 text-sm text-gray-100">Categories</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
	...
	<div class="container w-full mx-auto pt-20">
		...
		<button class="modal-open px-4 bg-indigo-500 p-3 rounded-lg text-white text-right hover:bg-indigo-400 mb-2">Create Category</button>
			...
			<div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
				...
				<div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
					...
					<div class="modal-content py-4 text-left px-6">
						...
						<!--Body-->
						<form class="flex flex-col" method="POST" action="category_action.php" id="createcategory">
								<div class="mb-6 pt-3 rounded bg-gray-200">
									<label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="name">Category Name</label>
